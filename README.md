...
Esse comando cria a pasta do projeto.
...
Esse comando permite entrar na pasta recém-criada.
...
Esse comando cria um ambiente virtual chamado `env`.
...
Instale as bibliotecas que serão utilizadas no projeto. Por exemplo:

```bash
pip install numpy pandas seaborn matplotlib
```

Cada biblioteca adiciona funcionalidades específicas. Por exemplo:

- `NumPy`: computação numérica e manipulação de vetores e matrizes.
- `Pandas`: manipulação e análise de dados.
- `Seaborn`: visualização estatística de dados.
- `Matplotlib`: criação de gráficos.

Caso seja necessário, outras bibliotecas poderão ser instaladas posteriormente.
